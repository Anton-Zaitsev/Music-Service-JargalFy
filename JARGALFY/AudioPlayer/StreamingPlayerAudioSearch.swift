//
//  StreamingPlayerAudioSearch.swift
//  JARGALFY
//
...
import AVFoundation
import RemoteImage
struct StreamingPlayerAudioSearch: View {
    @EnvironmentObject var datasongsSearch : SearchMusikJargalFy
    ...
    var withScreen  = UIScreen.main.bounds.width-30
    ...
    var body: some View {
        if self.datasongsSearch.Search.count != 0{
            VStack{
                HStack{
                    if !self.show {
