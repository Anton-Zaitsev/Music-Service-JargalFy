...
import RemoteImage
import Firebase
struct StreamingAudioforMedia: View {
    ...
    var body: some View {
        if self.DataMedia.MediaData.count != 0{
            VStack{
                HStack{
                    if !self.show {
                                ...
                                ZStack (alignment: .bottom){
                                    ...
                                    VStack{
                                        HStack {
                                            ...
                                            Spacer()
                                            Text("Моя любимая музыка").fontWeight(.bold).foregroundColor(Color(red: 179.0/255.0, green: 179.0/255.0, blue: 179.0/255.0)).font(.system(size: UIScreen.main.bounds.width/23))
                                            Spacer()
